...
void benchmark(int num_threads, char *access_pattern, int file_size_in_bytes, int record_size_in_bytes)
{
    ...
    for(i=0;i < num_threads ; i++)
    {
        ...
        args->file_num_threads = &num_threads;
...
int main(int argc, char **argv)
{
    ...
    int file_size_in_bytes =  convert_to_byte(file_size) ; 
    int record_size_in_bytes = convert_to_byte(record_size); 
    ...
    benchmark(num_threads, access_pattern, file_size_in_bytes, record_size_in_bytes);
